...
public class Shooter extends SubsystemBase {
	...
	private static final double kFlywheelVelocityConversion = 600.0 / 2048; // native units to rpm
	...
	private final MedianFilter movingFilter_;
	...
	public void periodic() {
		if (!runningOpenLoop_) {
			...
			// try const accelerator demand
			backSpinPID.setReference(9000, ControlType.kVelocity);
		} else {
	...
	private class ShooterDisplay {
		...
		private final ShuffleboardLayout m_layout = m_tab.getLayout("Shooter", BuiltInLayouts.kGrid)
				.withPosition(2, 0).withSize(6, 6);
		private final NetworkTableEntry m_backSpeed;
		private final NetworkTableEntry m_backSetpointSpeed;
		private final NetworkTableEntry m_backSpinP;
		private final NetworkTableEntry m_backSpinF;
		private final NetworkTableEntry m_flywheelSpeed;
		private final NetworkTableEntry m_flywheelSetpointSpeed;
		private final NetworkTableEntry m_flywheelP;
		private final NetworkTableEntry m_flywheelF;
