...
public class Hood extends SubsystemBase {
	...
	private static final int HOOD_MOTOR_ID = 23;
	private static final double kHoodMotorGearRatio = 81;
	private static final double ticksPerDegree = 1 / 1;
	private static final double degreesPerTick = 1 / 1;
	private static final double kHoodP = 1.0D;
	private static final double kHoodD = 0.0D;
	private static final double kHoodFF = 0.005D;
	private static final float kHoodUpperLimit = 50F;
	private static final float kHoodLowerLimit = 0F;
	private static final double kAimCoeffA = 1D;
	private static final double kAimCoeffB = 1D;
	private static final double kAimCoeffC = 1D;
	...
	private class HoodDisplay {
		private final ShuffleboardTab m_tab = Shuffleboard.getTab("Debug");
		private final ShuffleboardLayout m_layout = m_tab.getLayout("Hood", BuiltInLayouts.kList)
				.withPosition(0, 0)
				.withSize(2, 6);
		private final NetworkTableEntry m_current;
		private final NetworkTableEntry m_posAngleEntry;
		private final NetworkTableEntry m_posTicksEntry;
		private final NetworkTableEntry m_setpointEntry;
		private final NetworkTableEntry m_hoodPEntry;
		private final NetworkTableEntry m_hoodDEntry;
		private final NetworkTableEntry m_hoodFFEntry;
		private final NetworkTableEntry m_setters;
