...
public class DrivetrainSubsystem extends SubsystemBase {
	...
	private final ShuffleboardTab m_driverTab;
	private final NetworkTableEntry odometryEntry;
	private final Vector<ErrorCode> canFR = new Vector<ErrorCode>(10);
	private final Vector<ErrorCode> canFL = new Vector<ErrorCode>(10);
	private final Vector<ErrorCode> canBR = new Vector<ErrorCode>(10);
	private final Vector<ErrorCode> canBL = new Vector<ErrorCode>(10);
	 ...
	 *
	 * @return Degreess from the Pigeon (NOT ROTATION2D)
	 */
