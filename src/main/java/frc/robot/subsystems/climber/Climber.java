...
public class Climber extends SubsystemBase {
	...
	private final CANSparkMax m_leftElevatorMotor;
	private final CANSparkMax m_rightElevatorMotor;
	private final TalonFX m_leftPivot;
	private final TalonFX m_rightPivot;
	private final SparkMaxPIDController m_rightElevatorController;
	private final SparkMaxPIDController m_leftElevatorController;
	private final PIDGains m_elevatorUnloadedGains;
	private final ElevatorFeedforward m_elevatorFF;
	private final ShuffleboardLayout climberLayout;
	private final NetworkTableEntry stateEntry;
	private final NetworkTableEntry pivotPos;
	private final NetworkTableEntry elevatorPos;
	private final NetworkTableEntry pivotVoltage;
	...
	private final Command calibrateClimber() {
		return new ClimberCommandBuilder(
				...
				ClimberStates.IDLE,
				this).andThen(new InstantCommand(() -> {
			m_leftPivot.setSelectedSensorPosition(0);
